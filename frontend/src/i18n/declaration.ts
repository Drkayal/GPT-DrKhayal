...
export enum I18nKey {
  ...
  CHAT$MODEL_LABEL = "CHAT$MODEL_LABEL",
  CHAT$MODEL_NOT_SET = "CHAT$MODEL_NOT_SET",
  CHAT$ASK_ANYTHING = "CHAT$ASK_ANYTHING",
  CHAT$GENERATE_IMAGE = "CHAT$GENERATE_IMAGE",
  CHAT$GENERATE_VIDEO = "CHAT$GENERATE_VIDEO",
  CHAT$DESCRIBE_IMAGE = "CHAT$DESCRIBE_IMAGE",
  CHAT$DESCRIBE_VIDEO = "CHAT$DESCRIBE_VIDEO",
  CHAT$GENERATED_IMAGE_ALT = "CHAT$GENERATED_IMAGE_ALT",
  CHAT$DOWNLOAD_VIDEO = "CHAT$DOWNLOAD_VIDEO",
}
